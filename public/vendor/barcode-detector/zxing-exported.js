 ...
 */
//#region node_modules/.pnpm/zxing-wasm@3.1.1_@types+emscripten@1.41.5/node_modules/zxing-wasm/dist/es/share.js
var e = [
	[
		"All",
		"*",
...
var _ = {
	...
	addQuietZones: !0,
	options: ""
}, ee = "3.1.1", te = "6c2961d2a9ea4bc4e4ae8f37b1497299f04dd861", ne = { locateFile: (e, t) => {
...
({ ...m }), [...m.formats], { ..._ };
//#endregion
//#region node_modules/.pnpm/zxing-wasm@3.1.1_@types+emscripten@1.41.5/node_modules/zxing-wasm/dist/es/reader/index.js
async function se(e = {}) {
	...
	async function fe() {
		function e(e, t) {
			return Mr = e.exports, Gn(Mr), ne(), Mr;
		}
		function t(t) {
			return e(t.instance);
		}
	...
	var b, x, S, pe, me, C, w, T, he = (e) => {
		...
		var t = new Se(e);
		return t.get_caught() || (t.set_caught(!0), k--), t.set_rethrown(!1), O.push(t), Nn(e);
	}, A = 0, xe = () => {
		$(0, 0);
		var e = O.pop();
		Ln(e.excPtr), A = 0;
	...
	var Dt = (e, t, n, r, i, a) => {
		...
		for (var r = 1; r <= 4; r *= 2) {
			var i = t * (1 + .2 / r);
			if (i = Math.min(i, e + 100663296), wn(Math.min(n, Cn(Math.max(e, i), 65536)))) return !0;
		}
		return !1;
	...
	function Gn(e) {
		jn = e.za, Q = i._free = e.Aa, Mn = i._malloc = e.Ca, Nn = e.Da, $ = e.Ea, Pn = e.Fa, Fn = e.Ga, In = e.Ha, Ln = e.Ia, Rn = e.Ja, zn = e.Ka, G.viijii = e.La, Bn = G.viijjijjjjjj = e.Ma, Vn = G.iiijj = e.Na, Hn = G.jiiii = e.Oa, G.iiiiij = e.Pa, G.iiiiijj = e.Qa, G.iiiiiijj = e.Ra, Un = e.xa, Wn = e.Ba;
	}
	var Kn = {
		q: be,
		x: xe,
	...
	function Dr(e, t, n, r, i, a, o, s, c, l, u, d, f, p, m, h) {
		var g = D();
		try {
	...
	function Or(e, t, n, r, i, a, o, s, c, l, u, d, f, p, m, h, g, _, ee, te) {
		var ne = D();
		try {
	...
	function jr() {
		...
		function e() {
			var e, t;
			i.calledRun = !0, !g && (re(), (e = _) == null || e(i), (t = i.onRuntimeInitialized) == null || t.call(i), ie());
		}
	...
	var Mr = await fe();
	return jr(), t = te ? i : new Promise((e, t) => {
		_ = e, ee = t;
	}), t;
}
function ce(e) {
...
var fe = "6a858c01e076bab3a1bd413e4f2cf5e5e45f819a0d9441d83c66993bc48ed38f", b = [
	["aztec", "Aztec"],
